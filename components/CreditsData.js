      ...
      <form action="" method="post">
        ...
        <div className="row">
          <div className="column col-large">
            ...
            <label for="credit_entity">Institución</label>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column col-large">
            ...
            <label for="credit_used_quota">Cupo utilizado</label>
          </div>
          <div className="column col-large">
            <input type="text" id="credit_line_amount" className="form-control"/>
            <label for="credit_line_amount">Cupo línea</label>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column col-large">
            ...
            <label for="credit_monthly_payment">Pago mensual</label>
          </div>
          <div className="column col-large">
            <input type="text" id="credit_expire_dt" className="form-control"/>
            <label for="credit_expire_dt">Vencimiento</label>
          </div>
          <div className="column col-large">
            <input type="text" id="credit_currency" className="form-control"/>
            <label for="credit_currency">Moneda</label>
          </div>
        </div>
        ...
        <div className="row">
          <div className="column col-large">
            ...
            <label for="credit_card_type">Tipo tarjeta</label>
          </div>
          <div className="column col-large">
            <input type="text" id="credit_payments_done" className="form-control"/>
            <label for="credit_payments_done">Cuotas pagadas</label>
          </div>
        </div>
